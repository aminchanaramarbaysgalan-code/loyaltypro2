    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="h-12 bg-white border-b flex items-center justify-between px-6">
          <h1 className="text-sm font-semibold">Хэрэглэгчид</h1>
                ...
                {filtered.length === 0 ? (
                  ...
                  return (
                    <tr key={c.id} onClick={() => setDetail(c)} className="border-b last:border-0 hover:bg-gray-50 cursor-pointer">
                      ...
                      <td className="px-4 py-3"><span className="text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full">{REGIONS[c.region]}</span></td>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl border p-6 w-80">
            ...
            <div className="space-y-3">
              ...
              <div className="text-xs text-gray-400 bg-gray-50 rounded-lg p-2">Шинэ хэрэглэгч 4% tier-ээс эхэлнэ</div>
            </div>
          ...
          <div className="bg-white rounded-xl border p-6 w-96">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <div className="text-xs text-gray-400 mt-1">Ашиглах боломж (50%)</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-3">
